              ...
              onClick={() => {
                modals.openConfirmModal({
                  ...
                  children: (
                    <div>
                      <Text>
                        Are you sure you want to post faction rankings to
                        Discord?
                      </Text>
            ...
            <Button
              onClick={() => {
                modals.openConfirmModal({
                  ...
                  children: (
                    <div>
                      Are you sure you want to fetch Discord users? This will
                      fail if you do it too often. Eventually this will be
                      maintained automatically. You probably only need to do
                      this if someone has joined the Discord and you can't see
                      them to match to a player from an event.
                    </div>
                  ),
                  onConfirm: () => {
