  ...
  return (
    <Stack gap="md">
      ...
      <List listStyleType="disc">
        ...
        <List.Item>Should be advertised on at least two platforms (Discord, Facebook, Wyrd Forums, as examples)</List.Item>
      </List>
      <Text>Each player's final score will be made up of their best five events across the year.</Text>
      <Text>
      ...
      <List listStyleType="disc">
        ...
        <List.Item>UK Malifaux Nationals (typically 7 rounds) – 140 points</List.Item>
      </List>
    </Stack>
  )
}
