...
import { TownPointsMap } from '#/components/town-points-map'
...
function RouteComponent() {
  ...
  // The town map isn't animated, so it shows the same window as the choropleth's
