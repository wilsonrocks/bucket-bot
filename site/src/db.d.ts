...
export interface RegionSnapshotBatch {
  created_at: Generated<Timestamp>;
  id: Generated<number>;
}
...
export interface TeamRankingSnapshot {
  batch_id: number;
  event_count: number | null;
  new_team: Generated<boolean>;
...
export interface TeamRankingSnapshotBatch {
  created_at: Generated<Timestamp>;
  id: Generated<number>;
  type_code: string;
}
