...
describe('buildSrcSet', () => {
  ...
  it('embeds the image key in each variant url', () => {
    const srcSet = buildSrcSet('painting/deadbeef')
    expect(srcSet).toContain('painting/deadbeef-w150.png 150w')
    expect(srcSet).toContain('painting/deadbeef-w1200.png 1200w')
  })
})
