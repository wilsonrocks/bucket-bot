...
export class InfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    if (!process.env.PROD_DISCORD_FACTION_CHANNEL_ID) {
      throw new Error("PROD_DISCORD_FACTION_CHANNEL_ID env var is not set");
    }
    ...
    const backendLambda = new lambda.Function(this, "BucketBotHandler", {
      ...
      environment: {
        ...
        DISCORD_FACTION_CHANNEL_ID: process.env.PROD_DISCORD_FACTION_CHANNEL_ID,
      },
    });
